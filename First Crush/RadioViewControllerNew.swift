...
class RadioViewControllerNew:UICollectionViewController, UICollectionViewDelegateFlowLayout,WKUIDelegate, WKNavigationDelegate,UITabBarControllerDelegate{
    let radioCellId="radioCellId"
    let tabNames = ["Radio","Bollywood","Hollywood","Punjabi","EDM"]
    let URL = ["http://www.firstcrush.co/first-crush-101-radio/","http://www.firstcrush.co/first-crush-101-radio/bollywood","http://www.firstcrush.co/first-crush-101-radio/hollywood","http://www.firstcrush.co/first-crush-101-radio/punjabi","http://www.firstcrush.co/first-crush-101-radio/edm"]
    ...
    override func viewDidLoad() {
        ...
        if let flowLayout = collectionView?.collectionViewLayout as? UICollectionViewFlowLayout {
            ...
            collectionView?.register(RadioCell.self, forCellWithReuseIdentifier: radioCellId)
        ...
        //Menu Bar Setup
        radioMenuBar  = RadioMenuBar(frame:CGRect(x: 0,y: 0,width: self.view.frame.width,height: 45))
        radioMenuBar.radioController?=self
        setupCollectionView()
    }
    ...
    func setupCollectionView(){
        ...
        radioMenuBar.trailingAnchor.constraint(equalTo: view.trailingAnchor,constant:0.0).isActive=true
        radioMenuBar.heightAnchor.constraint(equalToConstant: 45).isActive=true
    ...
    lazy var radioMenuBar: RadioMenuBar = {
        let rmb = RadioMenuBar()
        rmb.radioController = self
        rmb.translatesAutoresizingMaskIntoConstraints=false
        return rmb
    }()
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell=collectionView.dequeueReusableCell(withReuseIdentifier: radioCellId, for: indexPath) as! RadioCell
    ...
    override func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        radioMenuBar.collectionView.selectItem(at: selectedIndexPath, animated: false, scrollPosition: [])
...
class RadioCell:UICollectionViewCell, UIScrollViewDelegate, WKNavigationDelegate,WKUIDelegate, UITabBarControllerDelegate{
    ...
    func setupViews(){
        ...
        if Reachability.isConnectedToNetwork() == true {
            ...
            refreshControl.addTarget(self, action: #selector(RadioCell.refreshWebView), for: UIControlEvents.valueChanged)
